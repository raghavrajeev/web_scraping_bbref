...
conf_finalists=[]
excel=pd.read_excel('C:/Users/HP/Desktop/New folder/NBA/OC/Finals_Teams_Age/conf_finalist_list.xlsx')
for it in range(len(excel['team'].values)):
    team=excel['team'].values[it].upper()
    team=team.replace(' ','_')
    conf_finalists.append([Team[team],excel['year'].values[it]])

i=0
conf_finalists_list=[]
for i in range(len(conf_finalists)):
    playoff_total_time=get_playoff_total_time(conf_finalists[i][0],conf_finalists[i][1])
    ...
    print(conf_finalists[i][0].name,conf_finalists[i][1],': Minutes Averaged Age = ',mins_avg_age)
    conf_finalists_list.append(conf_finalists[i][0].name,conf_finalists[i][1],mins_avg_age)

excel_plot=pd.read_excel('C:/Users/HP/Desktop/New folder/NBA/OC/Finals_Teams_Age/conf_finalist_age_since_1980.xlsx')
...
winner_list=pd.read_excel('C:/Users/HP/Desktop/New folder/NBA/OC/Finals_Teams_Age/conf_finalist_list.xlsx')
...
ax.set_title('NBA conference finalists age (mins averaged)',fontsize=10)
